...
Eclipse 3.5 plugin to set the Mac represented document in the
window so that DTerm works.

License

Kathryn Huxtable makes available all content in this plug-in
...
If you did not receive this Content directly from Kathryn
Huxtable, the Content is being redistributed by another party
...
and such source code may be obtained at
    http://khuxtable.github.com/set-mac-document
